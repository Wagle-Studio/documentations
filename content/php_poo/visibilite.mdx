...
Lorsqu'une [classe étend une autre](/documentations/php_poo/heritage), la classe enfant peut redéfinir toute propriété qui n'est pas marquée `final`. Elle peut alors élargir la visibilité de lecture ou d'écriture, à condition que la nouvelle visibilité soit égale ou plus permissive que celle de la classe parente.
