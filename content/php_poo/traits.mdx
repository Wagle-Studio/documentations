...
Les traits réduisent les limites de l'[héritage](/documentations/php_poo/heritage) simple en autorisant le développeur à réutiliser un ensemble de méthodes dans plusieurs classes. La sémantique entre les classes et les traits réduit la complexité et évite les problèmes typiques de l'héritage multiple.
