...
Dans les cas d'[héritage](/documentations/php_poo/heritage), les constructeurs parents ne sont pas appelés implicitement si la classe enfant définit un constructeur.
