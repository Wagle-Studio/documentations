...
Découpler l'interface utilisateur du serveur permet aux composants d'évoluer indépendamment.
...
Les communications sans état conduisent à une utilisation plus efficace des ressources du serveur. Cela facilite grandement la mise à l'echelle : si aucun état n'est stocké côté serveur cela signifie que l'utilisateur peut s'adresser à n'importe quel serveur du cluster.
