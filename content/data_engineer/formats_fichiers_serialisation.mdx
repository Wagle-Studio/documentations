...
> 💡 Bon à savoir : c'est exactement la même distinction que row store vs column store côté bases de données, approfondie dans la leçon sur OLTP et OLAP, mais appliquée ici à des fichiers plutôt qu'à un moteur de base de données.
