...
Pour démarrer un nouveau projet avec Git, vous devez d'abord initialiser un dépôt local puis le [lier à un dépôt distant](/documentations/git/installer_git) (GitHub/GitLab).
