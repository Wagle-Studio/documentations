...
Ajoutez les directives d’authentification dans le [virtual host](/documentations/apache/virtual_host), dans un bloc `<Directory>` ou `<Location>` selon le périmètre à protéger.
