...
🔗 [Documentation .htpasswd - Apache](https://httpd.apache.org/docs/2.4/fr/programs/htpasswd.html)
...
- `AuthType Basic` : spécifie l'utilisation de l'authentification basique.

- `AuthName` : message affiché dans la fenêtre d'authentification.
...
Dès lors, le site n’est plus chargé tant que l’utilisateur n’a pas saisi la combinaison identifiant + mot de passe dans la fenêtre affichée à l’ouverture de la page.
